  ...
  return (
    <section className="py-12 md:py-20 bg-ink">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        <SectionReveal className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-6 md:mb-8">
          <div>
          ...
          <SectionReveal.Body className="text-[0.9rem] text-text-2 max-w-sm block">
            {lang === "fr"
          ...
          {RECENT_ITEMS.map((item, i) => (
            ...
            >
              <TiltCard className="rounded-2xl h-full">
                <GlassCard className="p-4 h-full group cursor-pointer border-gold/30 group-hover:border-gold/60">
                  ...
                  <TiltCard.Image className="aspect-[4/3] rounded-lg bg-ink-2 mb-3 flex items-center justify-center">
