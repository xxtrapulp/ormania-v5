...
- Name: modals.spec.ts >> en — modals >> product modal opens from Recently section
- Location: e2e/modals.spec.ts:29:9
...
Call log:
  - waiting for locator('button').filter({ hasText: 'Ask About This' }).first()
