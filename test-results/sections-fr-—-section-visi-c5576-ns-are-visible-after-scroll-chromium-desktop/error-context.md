...
- Name: sections.spec.ts >> fr — section visibility >> home page sections are visible after scroll
...
Expected length: 0
Received length: 12
Received array:  [{"class": "inline-block will-change-[opacity] text-gold-3 italic gold-glow", "tag": "SPAN", "text": "m"}, {"class": "inline-block will-change-[opacity] text-gold-3 italic gold-glow", "tag": "SPAN", "text": "é"}, {"class": "inline-block will-change-[opacity] text-gold-3 italic gold-glow", "tag": "SPAN", "text": "m"}, {"class": "inline-block will-change-[opacity] text-gold-3 italic gold-glow", "tag": "SPAN", "text": "o"}, {"class": "inline-block will-change-[opacity] text-gold-3 italic gold-glow", "tag": "SPAN", "text": "r"}, {"class": "inline-block will-change-[opacity] text-gold-3 italic gold-glow", "tag": "SPAN", "text": "a"}, {"class": "inline-block will-change-[opacity] text-gold-3 italic gold-glow", "tag": "SPAN", "text": "b"}, {"class": "inline-block will-change-[opacity] text-gold-3 italic gold-glow", "tag": "SPAN", "text": "l"}, {"class": "inline-block will-change-[opacity] text-gold-3 italic gold-glow", "tag": "SPAN", "text": "e"}, {"class": "inline-block will-change-[opacity] text-gold-3 italic gold-glow", "tag": "SPAN", "text": "s"}, …]
```
