...
- Name: modals.spec.ts >> fr — modals >> contact modal opens, is focusable, and closes with Escape
- Location: e2e/modals.spec.ts:7:9
...
Call log:
  - waiting for locator('button').filter({ hasText: 'Contactez-nous' }).first()
